                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="thick-line text-end">Ksh {{ $total_sum }}
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line text-end">Ksh {{ $payment->due_amount }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="no-line"></td>
                                                                ...
                                                                <td class="no-line text-end">
                                                                    <h4 class="m-0">Ksh {{ $payment->total_amount }}
                                                                    </h4>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" name="paid_amount"
                                                            class="form-control paid_amount mt-3"
