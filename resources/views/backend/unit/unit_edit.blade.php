                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('unit.update') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    <label for="short_code" class="col-sm-2 col-form-label">Short Code</label>
                                    <div class="form-group col-sm-10">
                                        <input name="short_code" value="{{ $unit->short_code }}" class="form-control"
                                            type="text" id="short_code">
                                    </div>
                                </div>
                                <!-- end row -->
