...
class CustomerController extends Controller
{
    ...
    public function CustomerUpdateInvoice(Request $request, $invoice_id)
    {
        if ($request->new_paid_amount < $request->paid_amount) {
            ...
            // Check if paid_status is either 'full_paid' or 'partial_paid'
            if ($request->paid_status != 'full_paid' && $request->paid_status != 'partial_paid') {
                $notification = array(
                    'message' => 'Sorry, Select a payment status',
                    'alert-type' => 'error'
                );
                return redirect()->back()->with($notification);
            }
